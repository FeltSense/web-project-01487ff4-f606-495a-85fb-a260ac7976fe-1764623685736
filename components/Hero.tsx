      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute -left-4 top-1/3 bg-white rounded-xl p-4 shadow-xl border border-slate-100 hidden lg:block"
          >
          ...
          <motion.div
            ...
            className="absolute -right-4 top-1/2 bg-white rounded-xl p-4 shadow-xl border border-slate-100 hidden lg:block"
          >
            <div className="flex items-center gap-3">
